...
public class DefaultAddressConverterTest {


    private final DefaultAddressConverter converter = new DefaultAddressConverter();
    ...
    public void shouldConvertModel() {
        Address addressModel = new StubbedAddress();
